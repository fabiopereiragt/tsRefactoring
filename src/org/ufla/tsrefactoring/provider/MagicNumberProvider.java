...
public class MagicNumberProvider implements IStructuredContentProvider {

	private static List<ResultTestSmellDTO> resultTestSmellDTO = new ArrayList<ResultTestSmellDTO>();

	public MagicNumberProvider() {
		resultTestSmellDTO = Analyzer.getFilesAnalyzed(TestSmell.MAGIC_NUMBER);
	}
